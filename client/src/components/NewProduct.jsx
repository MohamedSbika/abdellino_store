    ...
    useEffect(() => {
        ...
        const fetchLastProduct = async () => {
            try {
                ...
                setError('Erreur lors du chargement du produit'); // Set error message
            } finally {
                setLoading(false); 
            }
        };
    ...
    return (
        <section className="relative overflow-hidden bg-gray-100" style={{ height: '850px' }}>
            <div
                ...
                style={{
                    backgroundImage: `url(${produit?.imgUrl[0]})`, // Use optional chaining
                ...
                <div className="relative flex items-end justify-end p-8 h-full mr-48">
                    ...
                    >
                        <h2 className="text-4xl font-bold mb-4" data-aos="fade-right">
                            {produit?.title} {/* Optional chaining */}
                        </h2>
                        <h6 className="text-xl mb-4" data-aos="fade-left">
                            Prix : {produit?.prix} DT {/* Optional chaining */}
                        </h6>
