    ...
    <div>
        {pathname?
          <div className='sm:grid sm:grid-cols-2'>
           ...
           <div>
              <div className='flex items-center justify-center text-center text-lg my-2 font-bold'><FaTicketAlt className='mx-5'/> commandes des produits : {commandesG.length}</div>
            </div>
            :
            <div>
