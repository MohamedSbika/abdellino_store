...
export default function Card1() {
  return (
    <div>
      <div className="  grid place-items-center max-h-full max-w-[100vw] pt-96 sm:pt-40 mx-auto sm:p-32 p-6 font-[sans-serif]">
        <div className="grid md:grid-cols-2 items-center gap-4 ">
          ...
          <div>
            <img
              src={logo}
              className="grid place-items-center sm:ml-8 rounded-lg pr-8"
              alt="Profile"
            />
          </div>
        </div>
